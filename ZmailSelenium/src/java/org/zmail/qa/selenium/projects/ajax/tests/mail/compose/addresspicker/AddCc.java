...
public class AddCc extends PrefGroupMailByMessageTest {
	...
	public void AddCc_01() throws HarnessException {
		...
		logger.info("Will add the following account to the Cc:" + ZmailAccount.AccountB().EmailAddress);
		...
		ZAssert.assertEquals(sent.dCcRecipients.get(0).dEmailAddress, ZmailAccount.AccountB().EmailAddress, "Verify the 'cc' field is correct");		
