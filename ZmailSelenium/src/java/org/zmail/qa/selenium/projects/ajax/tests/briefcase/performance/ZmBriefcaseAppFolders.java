 ...
 * ***** END LICENSE BLOCK *****
 */
package org.zmail.qa.selenium.projects.ajax.tests.briefcase.performance;
	...
	public void ZmBriefcaseAppFolders_01() throws HarnessException {
		...
		app.zGetActiveAccount().soapSend(
				"<CreateFolderRequest xmlns='urn:zmailMail'>" +
					"<folder name='case"+ ZmailSeleniumProperties.getUniqueString() + "' view='document' l='"+ root.getId() +"'/>" +
				"</CreateFolderRequest>");
