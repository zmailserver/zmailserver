...
public class AuthTokenTimeout extends PrefGroupMailByMessageTest {
	...
	public AuthTokenTimeout() {
		...
		super.startingAccountPreferences.put("zmailPrefAutoSaveDraftInterval", "240s");
		super.startingAccountPreferences.put("zmailAuthTokenLifetime", "100s");


	}
	
	@Bugs(ids = "75133")
	@Test(	description = "Verify content is saved when Send is interupted by zmailAuthTokenLifetime",
			groups = { "functional" })
