...
public class ZmailPrefComposeFormatHtml extends AjaxCommonTest {

	@SuppressWarnings("serial")
	public ZmailPrefComposeFormatHtml() {
	...
	@Test(
			description = "Set zmailPrefComposeFormat to 'html'",
			groups = { "functional" }
	)
	public void ZmailPrefComposeFormatHtml_01() throws HarnessException {
