...
public class BUG_46297 extends UpgradeOp {
    ...
    private void doEntry(ZLdapContext zlc, Entry entry, String entryName) throws ServiceException {
        ...
        String oldValue = "dn,zmailAccountCalendarUserType,zmailCalResType,zmailCalResLocationDisplayName,zmailCalResCapacity,zmailCalResContactEmail";
        String newValue = "dn,zmailAccountCalendarUserType,zmailCalResType,zmailCalResLocationDisplayName,zmailCalResCapacity,zmailCalResContactEmail,vcardUID,vcardURL,vcardXProps";
