...
public class DbActiveSyncMessage {

    public static final String TABLE_ACTIVESYNC_MESSAGE = "activesync_message";
    ...
    public static String getTableName(int mailboxId, int groupId) {
        return DbMailbox.qualifyTableName(groupId, TABLE_ACTIVESYNC_MESSAGE);
    }

    public static String getTableName(Mailbox mbox) {
        return DbMailbox.qualifyTableName(mbox, TABLE_ACTIVESYNC_MESSAGE);
    }
}
