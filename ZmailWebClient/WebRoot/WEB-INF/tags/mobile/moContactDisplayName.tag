...
<%@ tag import="org.zmail.cs.taglib.bean.BeanUtils,org.zmail.cs.taglib.bean.ZContactHitBean" %>
<%@ attribute name="contact" rtexprvalue="true" required="true" type="org.zmail.cs.taglib.bean.ZContactHitBean" %>
