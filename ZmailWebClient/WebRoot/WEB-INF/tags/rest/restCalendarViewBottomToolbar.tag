...
<table width="100%" cellspacing="0" class='Tb'>
    <tr>
        <td align="left" class="TbBt">
            <c:if test="${not empty requestScope.zmail_target_item_name}">
                <a href="/home/${requestScope.zmail_target_account_name}${requestScope.zmail_target_item_path}.ics"><app:img src="startup/ImgCalendarApp.png" alt="ics"/><span style='padding-left:5px'>${zm:cook(requestScope.zmail_target_item_name)}.ics</span></a>
            </c:if>
        </td>
