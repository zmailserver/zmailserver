...
<tr>
	...
	<td>
		<table>
			<tr>
				<td>
					<select name="zmailPrefMailItemsPerPage" id="itemsPP">
...
<c:if test="${mailbox.features.conversations}">
	<tr>
		...
		<td>
			<select name="zmailPrefGroupMailBy" id="groupMailBy">
...
<tr valign="middle">
	...
	<td>
		<table>
			<tr>
				<td>
					<input id="viewHtml" type="radio" name="zmailPrefMessageViewHtmlPreferred" value="TRUE" 
				...
				<td>
					<input id="viewText" type="radio" name="zmailPrefMessageViewHtmlPreferred" value="FALSE" 
...
<tr valign="middle">
    ...
    <td>
		<table>
			<tr>
				<td>
					<input id="viewRight" type="radio" name="zmailPrefReadingPaneLocation" value="right" 
				...
				<td>
					<input id="viewBottom" type="radio" name="zmailPrefReadingPaneLocation" value="bottom" 
                ...
                <td>
                    <input id="noReadingPane" type="radio" name="zmailPrefReadingPaneLocation" value="off" 
...
<tr>
	...
	<td>
		<app:optCheckbox boxfirst="true" label="optionsShowFragments" pref="zmailPrefShowFragments" 
...
<c:if test="${mailbox.features.initialSearchPreference}">
	...
	<tr>
		<td class='ZOptionsTableLabel'>
			<label for="zmailPrefMailInitialSearch"><fmt:message key="optionsDefaultMailSearch"/>:</label>
		</td>
		<td>
			<input id="zmailPrefMailInitialSearch" size="40" type="text" name='zmailPrefMailInitialSearch' 
...
<c:if test="${mailbox.features.mailForwarding}">
	...
	<tr>
		...
		<td style='padding-left:20px'>
			<input id="zmailPrefMailForwardingAddress" size="40" type="text" name='zmailPrefMailForwardingAddress' 
	...
	<tr>
		<td class='ZOptionsTableLabel'>&nbsp;</td>
		<td style='padding-left:20px'>
			<app:optCheckbox boxfirst="true" label="mailDeliveryDisabled" pref="zmailPrefMailLocalDeliveryDisabled"
...
<c:if test="${mailbox.features.newMailNotification}">
	<tr>
		...
		<td>
			<app:optCheckbox boxfirst="true" trailingcolon="true" label="mailNotifEnabled" pref="zmailPrefNewMailNotificationEnabled"
	...
	<tr>
		<td class='ZOptionsTableLabel'>&nbsp;</td>
		<td style='padding-left:20px'>
			<input id="zmailPrefNewMailNotificationAddress" size="40" type="text" name='zmailPrefNewMailNotificationAddress' 
...
<c:if test="${mailbox.features.outOfOfficeReply}">
	<tr>
		...
		<td>
			<app:optCheckbox boxfirst="true" trailingcolon="true" label="awayMessageEnabled" pref="zmailPrefOutOfOfficeReplyEnabled"
	...
	<tr>
		<td class='ZOptionsTableLabel'>&nbsp;</td>
		<td style='padding-left:20px'>
			<textarea id="zmailPrefOutOfOfficeReply" name='zmailPrefOutOfOfficeReply' 
	...
	<tr>
        ...
        <td style='padding-left:20px'>
			...
			<input id="zmailPrefOutOfOfficeFromDate" size="20" type="text" name='zmailPrefOutOfOfficeFromDate' value="${fmtDate}">
	...
	<tr>
		...
		<td style='padding-left:20px'>
			...
			<input id="zmailPrefOutOfOfficeUntilDate" size="20" type="text" name='zmailPrefOutOfOfficeUntilDate' value="${fmtDate}">
			<span style='padding-left:5px' class='ZOptionsHint'><fmt:message key="CAL_APPT_EDIT_DATE_FORMAT"/></span>
		</td>
	</tr>
</c:if>
	...
	<td>
		<table>
			<tr>
				...
				<td>
					<input id="dedupeNone" type="radio" name="zmailPrefDedupeMessagesSentToSelf" value="dedupeNone" 
				...
				<td>
					<input id="secondCopy" type="radio" name="zmailPrefDedupeMessagesSentToSelf" value="secondCopyifOnToOrCC" 
				...
				<td>
					<input id="dedupeall" type="radio" name="zmailPrefDedupeMessagesSentToSelf" value="dedupeAll" 
...
<c:if test="${mailbox.features.pop3Enabled}">
	...
	<tr>
		...
		<td>
			<table>
				<tr>
					<td><input id="pop3DownloadAll" name='zmailPrefPop3DownloadSince' type="radio"
				...
				<tr>
					<td><input id="pop3DownloadFromNow" name='zmailPrefPop3DownloadSince' type="radio"
