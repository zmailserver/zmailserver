...
<table width="100%">
    <tr>
        ...
        <tr>
            ...
            <td>
                <table class="ZPropertySheet" cellspacing="6">
                    <tr>
                        <td>
                            <input id="composeAsHTML" type="radio" name="zmailPrefComposeFormat" value="html" 
                        ...
                        <td>
                            ...
                            <select name="zmailPrefHtmlEditorDefaultFontFamily" id="composeFont">
                        ...
                        <td>
                            <select name="zmailPrefHtmlEditorDefaultFontSize" id="composeSize">
                        ...
                        <td>
                            <select name="zmailPrefHtmlEditorDefaultFontColor" id="composeColor">
                    ...
                    <tr>
                        <td>
                            <input id="composeAsText" type="radio" name="zmailPrefComposeFormat" value="text" 
        ...
        <tr>
            ...
            <td>
                <app:optCheckbox boxfirst="true" trailingcolon="false" label="optionsReplyForwardInSameFormat" 
					pref="zmailPrefForwardReplyInOriginalFormat" checked="${mailbox.prefs.forwardReplyInOriginalFormat}"/>
            </td>
        </tr>
        <app:optSeparator/>
        <tr>
        ...
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <input id="replyIncludeBody" type="radio" name="zmailPrefReplyIncludeOriginalText" value="includeBody" 
                        ...
                        <td>
                            <input id="replyIncludeBodyWithPrefix" type="radio" name="zmailPrefReplyIncludeOriginalText" value="includeBodyWithPrefix" 
                        ...
                        <td>
                            <input id="replyIncludeAsAttachment" type="radio" name="zmailPrefReplyIncludeOriginalText" value="includeAsAttachment" 
                        ...
                        <td>
                            <input id="replyIncludeNone" type="radio" name="zmailPrefReplyIncludeOriginalText" value="includeNone" 
        ...
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <input id="forwardIncludeBody" type="radio" name="zmailPrefForwardIncludeOriginalText" value="includeBody" 
                        ...
                        <td>
                            <input id="forwardIncludeBodyWithPrefix" type="radio" name="zmailPrefForwardIncludeOriginalText" value="includeBodyWithPrefix" 
                        ...
                        <td>
                            <input id="forwardIncludeAsAttachment" type="radio" name="zmailPrefForwardIncludeOriginalText" value="includeAsAttachment" 
        ...
        <tr>
            <td class='ZOptionsTableLabel'>&nbsp;</td>
            <td>
                <select name="zmailPrefForwardReplyPrefixChar" id="prefixText">
        ...
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <input id="saveSent" type="radio" name="zmailPrefSaveToSent" value="TRUE" 
        ...
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <input id="dontSave" type="radio" name="zmailPrefSaveToSent" value="FALSE" 
