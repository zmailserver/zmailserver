...
<app:view mailbox="${mailbox}" selected='mail' title="${message.subject}" context="${context}" folders="true" tags="true" searches="true" ads="${initParam.zmailShowAds != 0 ? ads : ''}" keys="true">
