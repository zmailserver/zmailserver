...
<%@ attribute name="convSearchResult" rtexprvalue="true" required="true" type="org.zmail.cs.taglib.bean.ZSearchResultBean"%>
<%@ attribute name="convCursor" rtexprvalue="true" required="true" type="org.zmail.cs.taglib.bean.NextPrevItemBean"%>
