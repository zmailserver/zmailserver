...
ZmMimeTable.APP_ZIMBRA_DOC			= "application/x-zmail-doc";
ZmMimeTable.APP_ZIMBRA_SLIDES		= "application/x-zmail-slides";
ZmMimeTable.APP_ZIMBRA_SPREADSHEET	= "application/x-zmail-xls";
...
ZmMimeTable.XML_ZIMBRA_SHARE		= "xml/x-zmail-share";
...
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_DOC]  	= {desc: ZmMsg.zmailDocument, image: "Doc", imageLarge: "Doc_48"};
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_SLIDES]	= {desc: ZmMsg.zmailPresentation, image: "Presentation", imageLarge: "Presentation_48"};
ZmMimeTable._table[ZmMimeTable.APP_ZIMBRA_SPREADSHEET] = {desc: ZmMsg.zmailSpreadsheet, image: "ZSpreadSheet", imageLarge: "ZSpreadSheet_48" };
