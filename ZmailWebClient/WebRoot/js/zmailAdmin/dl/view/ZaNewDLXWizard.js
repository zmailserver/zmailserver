...
ZaNewDLXWizard.ALIASES_TAB_ATTRS = [ZaAccount.A_zmailMailAlias];
...
ZaNewDLXWizard.PREF_TAB_ATTRS = [ZaDistributionList.A_zmailPrefReplyToEnabled, ZaDistributionList.A_zmailPrefReplyToDisplay,
...
ZaNewDLXWizard.myXFormModifier = function(xFormObject, entry) {
							...
							items : [
								{
									...
									elementChanged: function (elementValue, instanceValue, event) {
										...
										if (elementValue == ZaDistributionList.STATIC_DL_TYPE) {
											...
											if (this.getInstanceValue(ZaDistributionList.A_zmailIsACLGroup) != "TRUE") {
								...
								,
								{
									...
									visibilityChangeEventSources : [ZaDistributionList.A2_dlType],
									visibilityChecks : [ZaDLXFormView.isDynamicDL],
									enableDisableChangeEventSources : [ZaDistributionList.A_zmailIsACLGroup],
	...
	if(_tab4) {
		...
		if(entry.id) {
			...
			editAliasButton.enableDisableChecks = [ZaNewDLXWizard.isEditAliasEnabled,[ZaItem.hasWritePermission, ZaAccount.A_zmailMailAlias]];
		}
		...
		if(entry.id) {
			...
			deleteAliasButton.enableDisableChecks=[ZaNewDLXWizard.isDeleteAliasEnabled,[ZaItem.hasWritePermission, ZaAccount.A_zmailMailAlias]];
		}
		...
		{type:_CASE_, caseKey:_tab6, colSpan:"*",
			items:[
                ...
                {type:_GROUPER_, label:ZaMsg.NAD_MailOptionsReceiving, id:"dl_pref_replyto_group",
                    ...
                    visibilityChangeEventSources:[],
                    items: [
                        {ref:ZaDistributionList.A_zmailPrefReplyToEnabled, type:_WIZ_CHECKBOX_,
