...
function Com_Zmail_Search_Wikipedia(zimlet) {
	this.zimlet = zimlet;
	this.icon = "Wikipedia-Icon";
	this.label = "Search Wikipedia";
};

Com_Zmail_Search_Wikipedia.prototype.getSearchFormHTML = function(query) {
...
Com_Zmail_Search.registerHandler(Com_Zmail_Search_Wikipedia);
