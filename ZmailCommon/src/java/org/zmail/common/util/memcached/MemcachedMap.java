...
public class MemcachedMap<K extends MemcachedKey, V> {
     ...
     */
    public MemcachedMap(ZmailMemcachedClient client, MemcachedSerializer<V> serializer, boolean ackWrites) {
        mClient = client;
        mSerializer = serializer;
        mAckWrites = ackWrites;
    }

    public MemcachedMap(ZmailMemcachedClient client, MemcachedSerializer<V> serializer) {
