...
function () {
	return zmail_posixaccount.PosixGroupsListViewTitle;
}
/**
...
//idPrefix, label, iconInfo, width, sortable, sortField, resizeable, visible
	...
	headerList[1] = new ZaListHeaderItem(ZaPosixGroup.A_cn, zmail_posixaccount.DomainName, null, 200, null, ZaPosixGroup.A_cn, true, true);
	headerList[2] = new ZaListHeaderItem(ZaPosixGroup.A_description, zmail_posixaccount.Description, null, null, null, ZaPosixGroup.A_description, true, true);
